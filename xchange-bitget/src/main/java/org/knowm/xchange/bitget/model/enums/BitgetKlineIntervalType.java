package org.knowm.xchange.bitget.model.enums;
 ...
 */
public enum BitgetKlineIntervalType {
  ...
  private BitgetKlineIntervalType(String code, Long seconds) {
