...
public class KucoinAdapters {
  ...
  public static ExchangeMetaData adaptMetadata(
    ...
    for (SymbolResponse symbol : symbolsResponse) {
      ...
      if (symbolTickResponse != null
          && symbolTickResponse.getTakerCoefficient() != null
          && symbolTickResponse.getTakerFeeRate() != null) {
  ...
  public static CandleStickData adaptCandleStickData(
      CurrencyPair currencyPair, List<KucoinKline> kucoinKlines) {
    CandleStickData candleStickData = null;
    if (!kucoinKlines.isEmpty()) {
      List<CandleStick> candleStickList = new ArrayList<>();
      kucoinKlines.forEach(
          data ->
              candleStickList.add(
