...
public class MEXCAccountServiceV3 extends MEXCAccountServiceV3Raw implements AccountService {
    ...
    public String withdrawFunds(Currency currency, String chain, BigDecimal amount, AddressWithTag addressWithTag) throws IOException {

        return createMEXCWithdraw(currency, chain, amount, addressWithTag);
    }
